    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            result = {
                ...
                "row_traker_model_stats": run_manager.token_tracker._model_stats,
                "token_tracker_model_stats": run_manager.token_tracker.get_model_stats(),
            }

            print(f"✅ Question {question_index + 1} completed successfully (attempt {attempt + 1}) - Answer: {prediction} vs {true_answer}, Correct: {is_correct}")
            return result
